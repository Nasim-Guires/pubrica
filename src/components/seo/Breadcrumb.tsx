    ...
    <div className="bg-gray-50 border-y border-gray-100 py-3.5 select-none">
      <Container>
        <div className="flex items-center gap-2 overflow-x-auto whitespace-nowrap text-xs sm:text-sm text-gray-500 font-sans">
          ...
          <Link
            href="/"
            className="flex items-center gap-1 transition-colors text-blue-600 no-underline hover:no-underline"
          >
            ...
            return (
              <React.Fragment key={index}>
                ...
                {isLast || !item.href ? (
                  ...
                  <Link
                    href={item.href}
                    className="text-blue-600 no-underline hover:no-underline transition-colors"
                  >
                    {item.label}
                  </Link>
                )}
