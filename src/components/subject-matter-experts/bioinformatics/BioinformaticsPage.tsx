            ...
            <section className="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            As life sciences move toward data-intensive research, the demand for robust bioinformatics methodologies and analytical precision continues to grow. At Pubrica, we offer comprehensive research, writing, editing, and <Link href="/services/publication-support" className="text-blue-600 no-underline hover:no-underline">publication support</Link> for scholars, clinicians, and scientists working across all domains of bioinformatics.
                        </p>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed mb-2">
                            Pubrica offers a comprehensive suite of <Link href="/subject-matter-experts/bioinformatics" className="text-blue-600 no-underline hover:no-underline">bioinformatics services</Link> tailored to the <Link href="/subject-matter-experts/life-sciences" className="text-blue-600 no-underline hover:no-underline">life sciences</Link>, healthcare, and medical research sectors, supporting researchers in unraveling complex biological data and advancing scientific discoveries.
                        </p>
                        <p className="text-gray-600 text-sm leading-relaxed">
