                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            ...
                            <Link href="#" className="text-sky-600 hover:underline">healthcare industry</Link>,{" "}
                            <Link href="#" className="text-sky-600 hover:underline">agricultural</Link>, and energy sectors.
                        </p>

                        <p className="text-gray-600 text-sm leading-relaxed">
                            Pubrica provides customized{" "}
                            <Link href="#" className="text-sky-600 hover:underline">IoT research and publication services</Link> to global researchers, engineers or industry personnel in various fields or areas of research regarding IoT. Our IoT Services include expert research guidance, technical editing, and data interpretation, and we will assist you in preparing your research for publication from the conception of your idea until the final version is published. Our team of experienced experts in IoT will assist in turning a newly developed idea concept or technology into a{" "}
                            <Link href="#" className="text-sky-600 hover:underline">high-quality publication-ready manuscript services</Link> that meets worldwide standards for academic and industry journals.
                        </p>
