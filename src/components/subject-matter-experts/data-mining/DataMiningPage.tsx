...
export default function DataMiningPage() {
    const disciplines = [
        ...
        },
        {
            ...
            description: (
                <>
                    The application of classification, regression and time-series analysis as a way of forecasting future outcomes.{" "}
                    <Link
                    ...
                    has been applied across many different domains including health analytics, finance, marketing, and risk assessment.
                </>
            ),
            icon: TrendingUp,
        },
        ...
        <main className="w-full bg-[#FAFAFA] font-sans antialiased text-gray-800">
            ...
            <section className="py-7 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
                ...
                <CommonExpertiseCards
                    title="Our Expertise in Data Mining Research and Publication"
                    description="Pubrica provides a full range of support for your data mining research, including conceptual development, data analysis, and publication in leading research journals. A team of Ph.D.-qualified professionals throughout Pubrica specialize in areas such as: Big Data Analytics; Machine Learning; Statistical Modelling; and Computational Methods to assist researchers and data scientists to generate valid, reliable, and impactful results:"
