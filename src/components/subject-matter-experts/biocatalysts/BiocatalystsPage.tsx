                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Biocatalysts, commonly referred to as enzymes, are biological molecules that accelerate chemical reactions with remarkable specificity and efficiency. In today's rapidly evolving world of <Link href="#" className="text-sky-600 hover:underline">biotechnology</Link>, biocatalysts, enzymes, and whole-cell systems that accelerate chemical reactions are central to sustainable innovation. Whether in <Link href="#" className="text-sky-600 hover:underline">pharmaceuticals</Link>, food technology, <Link href="#" className="text-sky-600 hover:underline">animal science</Link>, or environmental applications, biocatalysts have revolutionized production methods, enabling more sustainable and efficient processes. At Pubrica, we provide comprehensive biocatalyst research and <Link href="#" className="text-sky-600 hover:underline">publication support</Link>, empowering scientists, scholars, and industry professionals to advance their research, optimize experiments, and disseminate knowledge effectively.
                        </p>

                        <p className="text-gray-600 text-sm leading-relaxed">
                            Our services integrate cutting-edge scientific expertise with publication-focused strategies, ensuring your research achieves both technical excellence and global visibility. With Pubrica, your <Link href="#" className="text-sky-600 hover:underline">biocatalyst research</Link> transitions seamlessly from the laboratory to high-impact publications.
                        </p>
