                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            At Empowering Discoveries in Enzymes, we provide manuscript writing, <Link href="/services/editing-and-translation" className="text-blue-600 no-underline hover:no-underline">scientific editing</Link>, and <Link href="/services/publication-support/" className="text-blue-600 no-underline hover:no-underline">publication support</Link> to researchers working in enzymology. Our expert team provides researchers in <Link href="/services/research-services/scientific-writing" className="text-blue-600 no-underline hover:no-underline">enzyme research</Link> with <Link href="/services/research-services/scientific-writing" className="text-blue-600 no-underline hover:no-underline">manuscript writing services</Link> from manuscript preparation through <Link href="/services/publication-support/journal-submission" className="text-blue-600 no-underline hover:no-underline">journal submission support</Link> and responding to <Link href="/services/publication-support/peer-review-pre-submission" className="text-blue-600 no-underline hover:no-underline">peer review</Link>. We will provide all services necessary to publish an article, so researchers can publish their research findings on enzymes in a professional manner and make them available for global distribution.
                        </p>
