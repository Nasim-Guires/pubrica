            ...
            <header className="bg-[#0e2723] text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto border border-gray-400/30 py-10 px-6 sm:px-12 text-center">
                    ...
                    <p className="text-sm sm:text-base text-gray-200 max-w-3xl mx-auto leading-relaxed">
                        Medical Animation explores three-dimensional representations of complex Health Care topics to make them easier for people to understand. The use of Medical Animation will improve patient Education, Medical Training, and Research Presentations by providing Visual Representations that can help people better comprehend the importance of Health Care.
                    </p>
                </div>
            </header>
