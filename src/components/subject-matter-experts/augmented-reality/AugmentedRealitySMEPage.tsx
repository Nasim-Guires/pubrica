                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {coreAreas.map((item, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all flex justify-between gap-3 h-40 relative"
                                >
                                    <div className="flex-1 flex flex-col min-w-0">
                                        <h3 className="text-xs font-bold text-[#b81c1c] leading-snug shrink-0 mb-2">
                                            {item.title}
                                        </h3>

                                        {/* Scrollable description box */}
                                        <div className="flex-1 overflow-y-auto card-scrollbar pr-2 text-[11px] text-gray-600 leading-relaxed max-h-20">
                                            <p>{item.desc}</p>
                                        </div>
                                    </div>
