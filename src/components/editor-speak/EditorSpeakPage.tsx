...
const experts = [
  {
    ...
    image: "Dr. Ravi Kumar Profile Photo",
    experience:
...

  {
    ...
    qualification: "MD",
    image: "Dr. Isaac Newton Rajkumar Profile Photo",
    experience:
          ...
          <nav className="border-t pt-4 space-y-2">
            ...
            {navItems.map((item) => (
              ...
              >
                ...
                <span
                  className={`text-xs font-semibold tracking-wide ${item.active
                      ? "text-gray-900"
                      : "text-gray-600"
                    }`}
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="mt-4 text-sm leading-relaxed">
                    ...
                    <p className="font-bold text-[#b94a48]">
                      Experience:
                    </p>
