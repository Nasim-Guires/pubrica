    ...
    <div className="w-full bg-[#f8fafc] text-slate-800 py-6 space-y-20">
      ...
      <section className="bg-white py-4 px-4">
        ...
        <div className="flex justify-center items-center mt-2">
          <Link
            href="/order-now/"
            className="inline-flex items-center justify-center px-4 py-3.5 text-base font-semibold text-white bg-red-600 rounded-full shadow-lg hover:bg-red-700 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 ease-in-out focus:outline-none focus:ring-4 focus:ring-red-600/30"
          >
