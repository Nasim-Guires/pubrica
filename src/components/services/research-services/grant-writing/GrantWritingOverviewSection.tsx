      ...
      <section className="w-full bg-[#f8fafc] py-6 sm:py-7 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-6xl mx-auto">
            {/* Main Heading */}
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0e3b38] leading-tight mb-5">
              Professional Research Grant Writing Services to Secure Funding
            </h2>

            <div className="flow-root">
              {/* Right Column: Layered Card Image (Retaining exact original image styling/design) */}
