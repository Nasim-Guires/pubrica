...
export const SystematicReviewOverview: React.FC = () => {
  return (
    ...
    >
      ...
      <HeroBanner
        title="Systematic Review Writing & Rewriting Services"
        description="Pubrica delivers expert literature synthesis, methodological precision, and publication-ready documentation to enhance the scientific credibility and impact of your research."
        headingAs="h1"
      />
      ...
      <section className="pt-6 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-[#113839] mb-3 leading-tight">
              Expert Systematic Review Services for Clinical and Evidence-Based Research
            </h2>

            <h3 className="text-base sm:text-lg text-[#0f2c3a] font-semibold mb-5 leading-snug">
              PRISMA, Cochrane &amp; PROSPERO-Compliant Reviews for Clinical, Healthcare, and Evidence-Based Research
            </h3>

            <div className="flow-root">
              {/* Right Image Column with Custom Backing Effect (Retaining exact original design/styling) */}
              ...
              <div className="space-y-5 text-gray-700">
                <p className="text-base leading-relaxed">
                  ...
                  , and PROSPERO registration standards can be challenging, especially for busy researchers and clinicians. At Pubrica, our team of experienced systematic literature review editors, data extractors, and medical and life science PhD writers delivers comprehensive{" "}
                  <Link
                  ...
                  across diverse disciplines, including clinical medicine, public health, nutrition and functional foods, pharma regulatory submissions, AI and machine learning research, and social sciences.
                </p>
                ...
                <p className="text-base leading-relaxed">
                  ...
                  , evidence synthesis, risk of bias measures, and statistical meta-analysis, ensuring methodological rigor, accuracy, and publication-ready quality. Our experts also identify key research gaps, highlighting missing or inadequate evidence to guide clinical decision-making, policy formulation, and future research priorities.
                </p>
            ...
            <section aria-labelledby="why-pubrica-title" className="mt-12 mb-12">
              <h2
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <article className="bg-white border-l-4 border-amber-500 p-6 rounded-lg shadow-xs hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    ...
                    , data extractors, and medical/life science PhD writers with experience in PRISMA, Cochrane, and PROSPERO-compliant reviews.
                  </p>
                </article>
                ...
                <article className="bg-white border-l-4 border-emerald-500 p-6 rounded-lg shadow-xs hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    From literature search strategy development and Rayyan/Covidence screening to{" "}
                    <Link
                ...
                <article className="bg-white border-l-4 border-purple-500 p-6 rounded-lg shadow-xs hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Expertise in clinical medicine, public health, nutrition, functional foods, pharma regulatory submissions, AI and machine learning, and environmental risk assessment.
                  </p>
                </article>
                ...
                <article className="bg-white border-l-4 border-blue-500 p-6 rounded-lg shadow-xs hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    ...
                    , and submission assistance to boost acceptance in high-impact journals.
                  </p>
                </article>
                ...
                <article className="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-xs hover:shadow-md transition-shadow md:col-span-2 lg:col-span-1">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Flexible scope, depth, and budget to match your research needs while maintaining methodological rigor and publication-ready quality.
                  </p>
                </article>
              </div>
            </section>
