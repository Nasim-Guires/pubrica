            ...
            <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
                <div className="space-y-3">
                    ...
                    <p className="text-xs sm:text-sm text-slate-700 leading-relaxed max-w-5xl">
                        ...
                        <Link href="#" className="text-sky-600 hover:underline">radiology</Link>,{' '}
                        <Link href="#" className="text-sky-600 hover:underline">cardiology</Link>, orthopedics, emergency medicine,{' '}
                        <Link href="#" className="text-sky-600 hover:underline">neurology</Link>, internal medicine, nuclear medicine, oncology, OB-GYN, otolaryngology, and more. Here's how we ensure high-quality CME content:
                    </p>
                </div>
