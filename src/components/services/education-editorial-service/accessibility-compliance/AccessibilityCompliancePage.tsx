                        ...
                        <div className="grid md:grid-cols-12 gap-8 items-center my-6">
                            ...
                            <div className="md:col-span-7 space-y-4 text-gray-700">
                                ...
                                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                    <li>
                                        Compliance to <Link href="#" className="text-blue-600 hover:underline">International Accessibility Standards</Link>, including WCAG and Section 508
                                    </li>
                                    ...
                                    <li>
                                        Compliance to <Link href="#" className="text-blue-600 hover:underline">Publisher-Specific Accessibility and Formatting Guidelines.</Link>
                                    </li>
                                </ul>
                            </div>
