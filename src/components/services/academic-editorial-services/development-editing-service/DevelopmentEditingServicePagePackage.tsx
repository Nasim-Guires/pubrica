      ...
      <main className="min-h-screen bg-white text-gray-800 font-sans">
        ...
        <section className="py-12 px-4 max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            ...
            {/* Card 1 */}
            <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-sm transition-all duration-300 group hover:bg-black hover:border-black">
              <p className="text-sm text-gray-700 leading-relaxed group-hover:text-white transition-colors duration-300">
        ...
        <section className="py-12 px-4 max-w-7xl mx-auto text-center bg-gray-50/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 text-left items-center">
        ...
        {/* =========================================================
            ...
            ========================================================= */}
        <section className="py-12 px-4 max-w-7xl mx-auto text-center bg-gray-50/50">
          <h2 className="text-2xl md:text-3xl font-bold text-[#1b3b36] mb-3">
          ...
          {/* Sample Document Viewer Box Placeholder */}
          <div className="max-w-4xl mx-auto bg-white border border-gray-300 rounded-lg p-4 shadow-sm mb-16">
            <div className="flex justify-between items-center bg-gray-100 p-2 rounded mb-4 text-xs">
          ...
          <p className="text-gray-600 text-sm max-w-3xl mx-auto mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            ...
            <div className="bg-white border border-gray-300 rounded-lg p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="text-xs font-bold text-gray-800 mb-2">Includes:</p>
            ...
            <div className="bg-white border border-gray-300 rounded-lg p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <ul className="text-xs text-gray-600 space-y-2 mb-6">
                  ...
                  <li>• Priority support and consultation with expert editors</li>
                </ul>
              </div>
              <div>
