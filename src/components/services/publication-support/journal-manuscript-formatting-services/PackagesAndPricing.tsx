...
export default function PackagesAndPricing() {
  ...
  const manuscriptFormattingSampleWork: PubricaSampleWorkCardProps = {
    bookCoverImage: {
    ...
    sections: [
      {
        heading: "Manuscript Formatting Sample Work",
        button: {
          label: "Discover More",
      ...
      },
      {
        ...
        descriptionSegments: [
          {
            text: "Explore our manuscript formatting sample work designed to meet your target journal's formatting guidelines, technical standards, and submission deadlines.",
          },
        ],
        button: {
          label: "Discover More",
