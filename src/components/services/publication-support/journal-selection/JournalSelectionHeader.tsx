    ...
    <div className="w-full bg-white text-slate-800 font-poppins">
      ...
      <section className="py-5 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-6 text-slate-800">
        ...
        <p className="text-base leading-snug">
          Our expert{' '}
          <Link href="/insights/incidence-cardiovascular-diseases-india-global" className="text-blue-600 no-underline hover:no-underline">
            journal selection
          </Link>{' '}
        ...
        <ul className="list-disc pl-6 text-base space-y-1 text-slate-800">
          ...
          <li>
            ...
            <Link href="/services/publication-support/journal-selection/understanding-cope-publication-ethics" className="text-blue-600 no-underline hover:no-underline">
              COPE
            </Link>
            , <a href="/services/publication-support/journal-selection/scientific-poster-design-presentation/" target="_blank" rel="noopener noreferrer" className="text-blue-600">ICMJE</a>, GPP)
          </li>
          <li>
            Avoid the risk of{' '}
            <Link href="/services/publication-support/journal-selection/journal-rejection-key-reasons-tips-for-improving-manuscripts/" className="text-blue-600 no-underline hover:no-underline">
              rejection
            </Link>{' '}
        ...
        <p className="text-base leading-snug">
          ...
          <Link href="/academy/journals-templates/journals-high-impact-springer-medical-journal" className="text-blue-600 no-underline hover:no-underline">
            journal selection
          </Link>{' '}
          ...
          <Link href="/insights/journal-selection-cervical-spondylosis-mechanical-neck-pain" className="text-blue-600 no-underline hover:no-underline">
            journal selection
          </Link>{' '}
        ...
        <p className="text-base leading-snug">
          ...
          <Link href="/services/publication-support/journal-selection/ckd-journal-selection-review" className="text-blue-600 no-underline hover:no-underline">
            journal selection
          </Link>{' '}
          services that will set up your{' '}
          <Link href="/academy/journal-selection/how-to-identify-best-journal-for-manuscript-submission" className="text-blue-600 no-underline hover:no-underline">
            manuscript’s submission
          </Link>{' '}
          to the most relevant,{' '}
          <Link href="/services/publication-support/journal-selection/high-impact-academic-journals-guide" className="text-blue-600 no-underline hover:no-underline">
