...
export default function PlagiarismSectionGroup() {
  // Active hovered step (defaults to Step 1 like in the screenshot design)
  ...
  return (
    <div className="w-full font-sans">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <ul className="space-y-4 list-disc pl-5 text-slate-700 text-sm md:text-base leading-relaxed marker:text-red-600">
                <li className="pl-1">
      ...
      <section className="w-full bg-[#f8fafc] py-12 md:py-16 px-4 md:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-[#0c373b] mb-4">
          ...
          <div className="relative pt-6 pb-2">
            ...
            <div className="hidden lg:block absolute top-[34px] left-8 right-8 h-2 bg-[#008ba3] -z-0" />
              ...
              {steps.map((step) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!isEven && (
                      <div className="w-10 h-10 rounded-full bg-[#008ba3] text-white font-bold flex items-center justify-center text-lg mb-4 shadow-sm transition-transform duration-300 group-hover:scale-110">
                        {step.stepNumber}
                      </div>
                    )}
                    ...
                    {/* Step Card */}
                    <div
                      className={`w-full min-h-[220px] p-5 rounded-sm border flex flex-col items-center justify-start transition-all duration-300 ease-in-out shadow-sm ${
                        isSelected
                    ...
                    >
                      ...
                      {/* Card Title */}
                      <h4
                        className={`font-bold text-xs md:text-sm tracking-wide mb-2 leading-tight uppercase transition-colors duration-300 ${
                          isSelected
                            ? "text-white"
                    ...
                    {isEven && (
                      <div className="w-10 h-10 rounded-full bg-[#008ba3] text-white font-bold flex items-center justify-center text-lg mt-4 shadow-sm transition-transform duration-300 group-hover:scale-110">
                        {step.stepNumber}
                      </div>
                    )}
                  </div>
      ...
      {/* SECTION 3: Banner */}
      <section className="w-full bg-[#0a2f2b] text-white py-8 px-4 md:px-8 text-center">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {standards.map((item) => (
              <div
                key={item.id}
                className="bg-white rounded-md border border-slate-200 p-6 flex flex-col items-center justify-between shadow-sm hover:shadow-md transition-shadow"
              >
                ...
                <p className="text-center font-bold text-[#0c373b] text-sm md:text-base leading-snug">
                  {item.title}
                </p>
              </div>
            ))}
