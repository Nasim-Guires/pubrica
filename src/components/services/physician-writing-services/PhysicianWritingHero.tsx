...
export const PhysicianWritingHero: React.FC<PhysicianHeroProps> = ({
  ...
  imageUrl = "/images/physician-writing-hero.jpg", // Replace with actual project image asset path
}) => {
  return (
    <section className="w-full bg-white py-12 px-6 md:px-12 lg:px-24 font-sans text-left">
      <div className="max-w-7xl mx-auto">
        {/* Main Page Title Header */}
        <h1 className="text-[#083c4c] text-2xl md:text-3xl lg:text-[32px] font-extrabold leading-tight tracking-tight mb-6 max-w-6xl">
          {title}
        </h1>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16 mb-6">
          ...
          <div className="flex-1 space-y-5">
            <h2 className="text-[#083c4c] text-lg md:text-xl font-bold tracking-tight">
              {sectionHeading}
            </h2>
            <p className="text-gray-700 text-sm md:text-[15px] leading-relaxed text-justify">
              Pubrica's{" "}
        ...
        <div className="w-full space-y-4 mb-10">
          ...
          <ul className="space-y-3.5 pl-1 max-w-5xl">
            {bullets.map((bullet, index) => {
              // Custom inline anchor highlights mapping for specialized items
              ...
              return (
                ...
                >
                  {/* Distinct Red Custom Bullet Dot */}
        ...
        <div className="flex flex-wrap items-center gap-4">
          <button className="bg-[#a80000] text-white text-xs md:text-sm font-bold tracking-wide px-6 py-3 rounded-full hover:bg-[#880000] transition-colors shadow-sm">
