        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-7 space-y-4 text-gray-700 leading-relaxed text-sm sm:text-base">
            ...
            <ul className="list-disc pl-5 space-y-2 text-rose-700 font-medium">
              <li>
                <span className="text-gray-700">Physicians with limited time for <Link href="/services/research-services/scientific-writing/" className="text-sky-600 hover:text-sky-800">scientific writing</Link></span>
              </li>
              <li>
      ...
      <section className="bg-gray-50 py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 max-w-5xl leading-relaxed text-sm sm:text-base mb-3">
            Pubrica provides specialized manuscript writing and <Link href="/services/publication-support" className="text-sky-600 hover:text-sky-800">publication support</Link> services for physicians looking to publish in indexed medical journals. Our clients include healthcare professionals from the <Link href="/industries/pharmaceutical" className="text-sky-600 hover:text-sky-800">pharmaceutical</Link>, <Link href="/Industries/medical-device/" className="text-sky-600 hover:text-sky-800">medical device</Link>, <Link href="/Industries/nutraceutical-research/" className="text-sky-600 hover:text-sky-800">nutraceutical</Link>, or life sciences sector.
          </p>
