...
const expertEditors: ExpertEditorItem[] = [
  {
    ...
    degree: "PhD - Nutraceutical Science",
  ...
  },
  {
    ...
    degree: "PhD - Herbal Nutraceuticals",
  ...
  {
    name: "Dr. Priya Nair",
    degree: "PhD - Nutraceutical Research",
    ...
    <div className="bg-white text-[#0f2824] w-full font-sans overflow-hidden">
      ...
      <section className="py-6 max-w-5xl mx-auto px-4 border-t border-gray-100">
        <WhereAuthorsPublish
          ...
          publication={{
            imageSrc:
              "/images/industries/nutraceutical-research/sample-works-5.webp",
            imageAlt: "Nutraceuticals Journal Cover",
            paperTitle: "Nutraceuticals in the Treatment of Major Depressive Disorder",
            author: "Davis A, Pence J, Bloomer RJ",
