...
export default function Navbar() {
  ...
  return (
    <>
      {/* 2. Floating Navbar Capsule Container wrapper */}
      <div className="bg-[#073632] pt-3 px-4 lg:px-8 relative z-50">
        {/* Removed overflow-hidden to allow absolute dropdown menus to display without clipping */}
        <div className="max-w-7xl mx-auto bg-white rounded-t-xl shadow-xl">
          {/* Main Top Contact Strip */}
          ...
          {/* Main Integrated White Menu bar */}
          <nav
            className={cn(
              "w-full bg-white transition-all duration-300 px-6 py-4 rounded-b-xl relative",
            )}
          >
            <div className="flex items-center justify-between">
              {/* Clean Logo Segment */}
                ...
                {NAV_LINKS.map((link) => {
                  ...
                  if (link.dropdown) {
                    return (
                      <div
                        key={link.label}
                        className="relative group px-2.5 py-2"
                      >
                        <Link
                          href={link.href}
                          className={cn(
                        ...
                        {/* Dropdown Container overlay setup */}
              ...
              <div className="hidden lg:flex items-center gap-2">
                <button
                  className="p-2.5 text-gray-700 hover:text-[#073632] hover:bg-gray-50 rounded-md transition-colors border border-gray-100 shadow-sm focus:outline-none"
                  aria-label="Search"
                >
