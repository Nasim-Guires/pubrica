      ...
      <Container className="w-full max-w-7xl flex flex-col">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-6 border-b border-gray-700/40 pb-12">
          ...
          <div className="lg:col-span-2 flex flex-col">
            <h4 className="text-sm font-bold text-white mb-5 font-display tracking-tight">Services</h4>
            <ul className="space-y-3.5 pl-0 list-none">
              {serviceLinks.map((link, idx) => (
                <li key={idx}>
                  <a href={link.href} className="text-[12px] text-gray-400 hover:text-white flex items-center gap-1.5 transition-colors group">
          ...
          <div className="lg:col-span-2 flex flex-col">
            <h4 className="text-sm font-bold text-white mb-5 font-display tracking-tight">About us</h4>
            <ul className="space-y-3.5 pl-0 list-none">
          ...
          <div className="lg:col-span-2 flex flex-col">
            <h4 className="text-sm font-bold text-white mb-5 font-display tracking-tight">More</h4>
            <ul className="space-y-3.5 pl-0 list-none">
