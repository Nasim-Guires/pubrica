...
import { ARTICLE_BLOCKS } from '@/lib/services-content/academic-editorial-services__ai-tools-for-academic-publishing';
...
export default function AcademicEditorialServicesAiToolsForAcademicPublishingPage() {
  return (
