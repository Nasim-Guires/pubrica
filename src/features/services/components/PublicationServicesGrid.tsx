        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {SERVICES_GRID_DATA.map((service, index) => (
            <a
              key={index}
              href={service.url}
              className="flex gap-3.5 p-4 rounded-lg border border-slate-200/80 bg-white shadow-sm transition-all duration-300 hover:bg-[#e3eff4] hover:shadow-md hover:translate-y-[-2px] group block"
            >
