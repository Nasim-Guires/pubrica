export const aiAndDataPreparationServicesWhoWeServe = {
  title: "Who We Serve",
  description:
...
export const aiAndDataPreparationServicesWorkflow = {
  heading: "How Our AI and Data Preparation Service Works",
...
export const aiAndDataPreparationServicesPackages = {
  title: "AI and Data Preparation Service – Our Packages",
  subtitle: "Choose the Right Package for Your Data Preparation Needs",
  description:
  ...
  packages: [
    {
      ...
      idealFor:
        "Researchers, students, and analysts needing clean, structured datasets.",
      includes: [
        "Data cleaning and error correction",
        "Basic structuring and formatting",
        "Removal of duplicates and inconsistencies",
        "Standard metadata preparation",
        "Initial quality checks",
      ],
      turnaround: "3–5 business days",
      bestFor: "Research datasets, pilot AI projects, academic studies",
    ...
    },
    {
      ...
      idealFor:
        "AI projects requiring structured, annotated, and optimised data.",
      includes: [
      ...
      bestFor: "Machine learning models, analytics projects, journal-linked datasets",
    ...
    },
    {
      ...
      idealFor:
        "Universities, enterprises, and large-scale AI initiatives.",
      includes: [
      ...
      bestFor: "Enterprise AI systems, funded research, high-stakes AI deployments",
