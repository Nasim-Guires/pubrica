export const learningDesignAndPedagogyWhoWeServe = {
    title: "Who We Serve",
    description:
        "Our Learning Design and Pedagogy Services support a wide range of individuals and institutions seeking high-quality, learner-focused educational experiences. We serve:",
...
export const learningDesignAndPedagogyWorkflow = {
    heading: "How Our Learning Design and Pedagogy Service Works",
    subheading: "Our Step-by-Step Process",
    description:
        "At Pubrica, we ensure that your educational content is instructionally effective, pedagogically sound, and learner focused. Our structured process includes:",
    ...
    packages: [
        {
            ...
            description:
                "Ideal For: Educators, trainers, and authors developing structured learning materials.",
            idealFor:
                "Educators, trainers, and authors developing structured learning materials.",
            includes: [
                "Learning objective refinement",
                "Content structuring and sequencing",
                "Basic pedagogical alignment",
                "Readability and clarity enhancement",
        ...
        },
        {
            ...
            description:
                "Ideal For: Institutions and authors requiring strong instructional rigor.",
            idealFor:
                "Institutions and authors requiring strong instructional rigor.",
            includes: [
                "All Basic Package features",
                "Learning theory integration",
                "Assessment redesign and alignment",
                "Learner engagement strategies",
                "Blended and online learning optimisation",
        ...
        },
        {
            ...
            description:
                "Ideal For: Universities, publishers, and large-scale educational initiatives.",
            idealFor:
                "Universities, publishers, and large-scale educational initiatives.",
            includes: [
                "All Advanced Package features",
                "Full curriculum redesign",
                "Accreditation and framework alignment",
                "Multi-format learning delivery support",
                "Expert QA and validation report",
...
export const learningDesignAndPedagogyTestimonials = {
    title: "Testimonials",
    description:
        "Pubrica provides an evidence-based approach to educational design that is centred around Learner Journey and success through measurable educational objectives for teachers, schools and organizations around the globe. The following testimonies demonstrate our approach to developing learning experiences that make an impact on the learner’s experience and their success:",
