...
export const HealthEconomicsOutcomeTestimonials = [
  {
    image:
      "/images/data-analytics-machine-learning/health-economics-outcome-research/journal-of-health-economics.png",
    quote:
      "Pubrica’s HEOR team provided exceptional support in developing a cost-effectiveness model for our oncology research. Their attention to regulatory compliance and scientific accuracy made our publication in the Journal of Health Economics seamless.",
    name: "Dr. Maria Gonzales",
    designation: "Health Economist",
    organization: "Spain",
    flag: "/images/data-analytics-machine-learning/health-economics-outcome-research/spain-.png",
  },
  {
    image:
      "/images/data-analytics-machine-learning/health-economics-outcome-research/international-journal-of-technology-assessment-in-health-care.png",
    quote:
      "The economic modeling and systematic reviews prepared by Pubrica exceeded our expectations. Their team combined technical depth with practical recommendations that directly supported our reimbursement submissions and a publication in the International Journal of Technology Assessment in Health Care.",
    name: "Prof. Ananya Iyer",
    designation: "Healthcare Outcomes Researcher",
    organization: "India",
    flag: "/images/editing-and-translation/book-editing/flag.png",
  },
  {
    image:
      "/images/data-analytics-machine-learning/health-economics-outcome-research/pharmacoeconomics-journal.png",
    quote:
      "With Pubrica’s HEOR expertise, we were able to design robust patient-reported outcome studies that met international guidelines. Their guidance elevated the credibility of our research findings, leading to acceptance in the Pharmacoeconomics journal.",
    name: "Dr. Akira Tanaka",
    designation: "Clinical Research Scientist",
    organization: "Japan",
    flag: "/images/data-analytics-machine-learning/health-economics-outcome-research/JAPAN-1.png",
  },
];

export const HealthEconomicsOutcomeFaqs = [
  {
    question:
      "Why is Health Economics & Outcomes Research (HEOR) important for pharmaceutical and medical device companies?",
    answer:
      "HEOR provides evidence on the clinical value, cost-effectiveness, and real-world impact of healthcare products. This evidence supports regulatory approvals, reimbursement decisions, pricing strategies, and successful market access.",
  },
  {
  ...
  {
    question:
      "How does HEOR support market access and pricing decisions?",
    answer:
  ...
  {
    question:
      "Can Pubrica's HEOR studies be published in peer-reviewed journals?",
    answer:
      "Yes. Our HEOR studies are developed to meet international scientific standards and can be prepared for publication in leading peer-reviewed journals. We also provide manuscript writing, journal formatting, and submission support.",
  },
  {
    question:
