export const patientJourneyInsightsWhoWeServe = [
  {
    title: "Pharmaceutical & Biotech Companies",
    bullets: [
      "Optimize clinical development and commercialization strategies",
      "Identify unmet medical needs and real-world patient behaviours.",
  ...
  },
  {
    ...
    bullets: [
      "Map patient journeys to improve care",
  ...
  },
  {
    ...
    bullets: [
      "Gain insights into cost-effectiveness and utilization patterns.",
      "Identify high-risk patient populations for proactive interventions.",
  ...
  },
  {
    ...
    bullets: [
      "Understand patient adoption pathways and diagnostic utilization.",
      "Align device/diagnostic development with real-world clinical needs.",
  ...
  },
  {
    ...
    bullets: [
      "Enhance protocol design with real-world data insights.",
      "Support patient recruitment and retention in clinical trials.",
  ...
  },
  {
    ...
    bullets: [
      "Provide evidence-based insights for evaluation of therapies.",
      "Support risk–benefit assessments using ML-driven RWE.",
...
export const patientJourneyInsightsFaqs = [
  {
    ...
    answer:
      "Machine learning automates the analysis of large-scale healthcare data, identifies hidden patterns, predicts patient needs, and generates actionable insights that improve patient outcomes and optimize healthcare processes.",
  },
  {
