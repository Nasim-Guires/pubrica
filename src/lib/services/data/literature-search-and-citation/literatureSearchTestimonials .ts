...
export const literatureSearchFaqs = [
  {
  ...
  },
  {
    ...
    answer:
      "Follow your target journal's citation guidelines, use trusted academic databases, verify every reference for accuracy, maintain a consistent citation style, and use citation management software to minimize formatting errors.",
  },
  {
