export const productDevelopmentWhoWeServe = {
  title: "Who We Serve",
...
export const productDevelopmentWorkflow = {
  heading: "How Our Product Development Service Works",
...
export const productDevelopmentPackages = {
  title: "Product Development Service – Our Packages",

  subtitle:
    "Our product development services offer end-to-end solutions, from concept ideation to market-ready products, tailored to meet industry standards and regulatory requirements.",

  description:
    "Our packages are designed to meet the specific research, validation, and regulatory intelligence needs of pharmaceutical, biotech, nutraceutical, herbal, cosmeceutical, pet health, medical device, and life science companies. Each tier delivers strategic support to accelerate your product’s path from discovery to market.",
  ...
  packages: [
    ...
    },
    {
      ...
      idealFor:
        "Teams preparing for formulation, R&D strategy, or investor discussions",
      includes: [
    ...
    },
    {
      ...
      idealFor:
        "Teams near preclinical, market entry, or submission phase",
      includes: [
    ...
    },
    {
      ...
      idealFor:
        "Clients with unique compound types, niche indications, or global compliance needs",
      includes: [
      ...
      turnaround: "",
      backgroundColor: "#d6e6c8",
      borderColor: "#b8d29d",
      headerTextColor: "#557a1f",
      bodyTextColor: "#374151",
    },
  ],
};

export const productDevelopmentTestimonials = {
  title: "Testimonials",
  ...
  testimonials: [
    {
      ...
      organization: "PharmaGenix, Germany",
    ...
    },
    {
      ...
      organization: "NutraCore Labs, USA",
    ...
    },
    {
      ...
      name: "Rajesh Kumar",
      designation: "CEO",
      organization: "Nutraceutical Innovations, India",
    ...
    },
    {
      ...
      organization: "VetLife Science, Canada",
    ...
    },
    {
      ...
      name: "Sanya Patel",
      designation: "Head of Translational Science",
      organization: "OncoTech Biologics, UK",
...
export const productDevelopmentFaqs = {
  title: "Frequently Asked Questions – Core Discovery & Intelligence Services",

  faqs: [
    {
      question: "1. How to find a research gap in my field?",
      answer:
        "A research gap may be identified by studying recent research studies, identifying questions that are yet to be answered, and consulting experts to find areas needing further investigation.",
    },
    {
      question: "2. How can researchers identify emerging research trends?",
      answer:
        "To identify emerging trends, researchers use various techniques such as analyzing recent publications, tracking citations, exploring databases, attending conferences, and tracking keywords.",
    },
    {
      question:
        "3. How do I choose a strong research topic for my study?",
      answer:
        "To select an effective research topic, you should align your interests with existing gaps in research, ensuring the research is relevant, feasible, and original.",
    },
    {
      question:
        "4. What tools and methods are used to analyse research trends and scientific developments?",
      answer:
        "Researchers use tools such as Scopus and Web of Science databases and techniques such as bibliometric analysis, citation analysis, keyword analysis, and systematic reviews to identify patterns and trends in research.",
    },
    {
      question:
        "5. How do I stay updated with the latest developments in my research area?",
      answer:
        "To remain updated, it is important to track key journals, set up databases, attend conferences, network with experts, and monitor recent publications and keywords in a particular field of study.",
    },
  ],
};