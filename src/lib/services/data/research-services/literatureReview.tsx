const LR_IMG = "/images/research-services/literature-review-and-gap";

export const literatureReviewTestimonials = [
  {
    image: `${LR_IMG}/bmc-medical-research-methodology-journal.png`,
    quote:
      "Pubrica's team delivered a comprehensive literature review that was both methodologically sound and well-written. Their gap analysis identified critical research areas we had overlooked. It was instrumental in shaping our grant proposal and later supported our publication in BMC Medical Research Methodology.",
    name: "Dr. A. Mehta",
    designation: "Academic Researcher",
    organization: "University of Delhi",
    flag: `${LR_IMG}/university-of-delhi-.png`,
    flagSrc: `${LR_IMG}/university-of-delhi-.png`,
  },
  {
    image: `${LR_IMG}/journal-of-clinical-epidemiology.png`,
    quote:
      "Thanks to Pubrica, we were able to meet our tight publication deadline with a high-quality literature review. The team's expertise in structuring and synthesizing the data helped us publish in the Journal of Clinical Epidemiology.",
    name: "Dr. Claire Thompson",
    designation: "Clinical Researcher",
    organization: "UK",
    flag: "/images/research-services/uk-flag-.png",
    flagSrc: "/images/research-services/uk-flag-.png",
  },
  {
    image: `${LR_IMG}/the-international-journal-of-life-science.png`,
    quote:
      "Their meticulous approach to identifying research gaps helped us refine our study objectives significantly. Pubrica's literature review services are top-tier and reliable—our final paper was accepted in the International Journal of Life Sciences.",
    name: "Prof. K. Ramasamy",
    designation: "PhD Guide, Life Sciences",
    organization: "India",
...
export const literatureReviewFAQ = [
  {
    question:
