...
export const predictiveAnalyticsFAQ = {
  ...
  faqs: [
    ...
    {
      question: "What types of predictive models do you provide?",
      answer: "We specialize in a range of models, including:",
      points: [
    ...
    {
      question: "How do I get started with your predictive analytics service?",
      answer:
    ...
    {
      question: "Is the service suitable for small businesses or startups?",
      answer:
