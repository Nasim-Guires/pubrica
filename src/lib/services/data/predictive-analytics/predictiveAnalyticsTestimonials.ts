 export const predictiveAnalyticsWhoWeServe = {
    title: "Who We Serve",
    description:
        "At Pubrica, our Predictive Analytics Services are designed to empower diverse stakeholders with data-driven foresight. We support organizations, researchers, and businesses that require actionable insights to anticipate trends, optimize decisions, and achieve measurable outcomes.",
    data: [
        {
            title: "Academic and Clinical Researchers",
            bullets: [
...
export const predictiveAnalyticsTestimonials = {
  title: "Testimonials",
  description:
...
export const predictiveAnalyticsFAQ = {
  title: "Frequently Asked Questions – Predictive Analytics Service",
  faqs: [
    {
      question:
        "What is predictive analytics, and how can it benefit my research or business?",
      answer:
    ...
    {
      question:
        "What types of predictive models do you provide?",
      answer:
        "We specialize in a range of predictive models, including Regression Models (linear, logistic, multivariate), Time Series Forecasting (ARIMA, Prophet), Classification Models (decision trees, random forests, SVM), Clustering and Segmentation Models (k-means, hierarchical clustering), and Deep Learning Models (neural networks for complex patterns)."
    },
    {
      question:
        "Can Pubrica help with publishing research based on predictive analytics?",
      answer:
    ...
    {
      question:
        "How do I get started with your predictive analytics service?",
      answer:
    ...
    {
      question:
        "Is the service suitable for small businesses or startups?",
      answer:
    ...
    {
      question:
        "Can you customize predictive models for my specific industry or research area?",
      answer:
