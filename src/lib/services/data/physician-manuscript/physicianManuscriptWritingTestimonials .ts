export const physicianManuscriptWritingTestimonials = [
    {
        image: "/images/physician-writing-services/physician-manuscript/jama-oncology-journal.jpg",
        quote:
            "I collaborated with Pubrica to convert my retrospective oncology study into a publishable article. The manuscript, submitted to JAMA Oncology, was written with clarity and scientific depth. Their support during peer review was especially helpful.",
        name: "Dr. M. Thompson, MD",
        designation: "Medical Oncologist",
        organization: "USA",
        flag: "/images/physician-writing-services/physician-manuscript/united-states-of-america.png",
    },
    {
        image: "/images/physician-writing-services/physician-manuscript/journal-of-clinical-and-diagnostic-research.jpg",
        quote:
            "Pubrica helped articulate my clinical data into a high-quality manuscript focused on Type 2 diabetes interventions. The manuscript was accepted in the Journal of Clinical & Diagnostic Research (JCDR). Their structured writing approach and data presentation were outstanding.",
        name: "Dr. S. Nair",
    ...
    {
        image: "/images/physician-writing-services/physician-manuscript/bmj-neurology-open.jpg",
        quote:
...
export const physicianManuscriptWritingFaqs = [
  {
