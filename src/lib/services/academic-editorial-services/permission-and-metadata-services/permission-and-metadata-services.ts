export const permissionAndMetadataServicesWhoWeServeData = {
  title: "Who We Serve",
  description:
    "At Pubrica, our Permission and Metadata Services are designed to support a wide range of academic and research professionals, ensuring that your work is legally compliant, discoverable, and publication-ready. We partner with scholars, institutions, and publishers to streamline permissions, copyright clearance, and metadata management.",

  data: [
    {
      title: "Researchers submitting manuscripts to international journals",
      bullets: [
        "We assist researchers in securing permissions for copyrighted content and ensuring metadata accuracy to meet global publication standards.",
    ...
    },
    {
      ...
      bullets: [
        "Students receive guidance on obtaining permissions for third-party materials and proper metadata tagging to ensure compliance with institutional and academic requirements.",
    ...
    },
    {
      ...
      bullets: [
        "We help research teams organize, annotate, and attach accurate metadata to datasets, while securing permissions for any external resources.",
    ...
    },
    {
      ...
      bullets: [
        "We assist review teams in managing references, extracting copyright-compliant materials, and applying structured metadata for comprehensive literature synthesis.",
...
export const permissionAndMetadataServicesTestimonialData = {
  title: "Testimonials",
  description:
    "At Pubrica, our Permission & Metadata Services are designed to ensure your scholarly work meets all copyright, licensing, and journal-specific requirements. From securing permissions to compiling accurate metadata, we manage every detail to make your manuscript fully compliant, publication-ready, and seamlessly acceptable to top-tier journals. Here’s what our clients have to say about our services:",
